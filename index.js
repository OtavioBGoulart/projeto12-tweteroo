...
const users = [
    ...
    { user: "BobEsponja", avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4tb8sTB9orxfk_rVAyYZZYVjJ3JkZRjq5N5jEdv6nhimu_lg5CI00V3rKVuq3lp6ZP-A&usqp=CAU" },
...
app.get("/tweets", (req, res) => {
    ...
    const indexAvatar = users.findIndex( u => u.user == tweets[i].user);
    //console.log(indexAvatar);
